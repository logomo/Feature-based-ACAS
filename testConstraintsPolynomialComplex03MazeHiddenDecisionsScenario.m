%%Scenario Maze solver - ideal decision points
clear
...
%Vehicle
    ...
    mazeMap=[1,1,1,1,1,1,1,1,1; % this one needs an additional waypoint guidance
             1,0,0,0,0,0,1,6,1;
             1,0,3,4,1,0,1,0,1;
             2,0,0,0,4,0,1,0,1;
             1,2,3,0,1,0,1,0,1;
...
%% This should be caclulated by algorithm in runtime
    missionControl1.waypoints = ...
                [  Waypoint(30,15,0),...
                   Waypoint(35,30,0),...
                   Waypoint(20,35,0),...
                   Waypoint(15,50,0),...
