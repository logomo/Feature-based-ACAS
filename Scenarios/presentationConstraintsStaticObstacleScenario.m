%% Scenario 7.3.1 Building Avoidance
clear
...
while ~missionControl1.finalWaypointReachedFlag
    ...
    drawnow
    Cmnf.exportFigure('ConstraintsBuildingObstacles',k);
end
...
%% Draw Clash distance performance
    ...
    hold off
    Cmnf.exportFigure('ConstraintsPolynomialBuildingObstaclesPerformance');
   
%% Trajectory tracking performance
    figure(3)
    title('Path following performance')
    missionControl1.plotRealvsPlanTrajectoryStatistics()
    Cmnf.exportFigure('ConstraintsPolynomialBuildingPathFollowing');
...
%% Computation Load 
 figure(4)
    ...
    title('UAS 1')
    aat'*100
    Cmnf.exportFigure('BuildingAvoidanceComputationTime');